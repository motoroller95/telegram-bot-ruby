  ...
  class Api
    ...
    def connection
      @connection ||= Faraday.new(url: url) do |faraday|
        ...
        faraday.adapter Telegram.configuration.adapter
        faraday.options.timeout = Telegram.configuration.connection_timeout
        faraday.options.open_timeout = Telegram.configuration.connection_open_timeout
      end
    end
